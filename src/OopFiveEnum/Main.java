...
import OopFiveEnum.Transport.DriverB;
...
//
//
        Bus.SeatType bus = Bus.SeatType.TIP_ESPEC_SMALL;
        bus.defineAutoType("средняя");
        Truks.LoadCapacityType truk = Truks.LoadCapacityType.TIP_N1;
        truk.defineAutoType("N");
    }
}
