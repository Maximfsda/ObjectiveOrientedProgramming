...
import OopSevenСollections.TwoOne.Trasnsport;
...
public abstract class Driver<A extends Trasnsport> {
    ...
    public String fio(){
        System.out.print(nameDriver+" категория прав-" + driverLicenceCategory +" Стаж работы-"+ experience +"года Управляет машиной: " + car);
        return " ";
    }
